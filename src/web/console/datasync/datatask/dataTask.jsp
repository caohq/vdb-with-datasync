...
<head>
    ...
    <script type="text/javascript" src="/console/shared/bootstrap-3.3.7/js/bootstrap.js"></script>
    ...
    <script type="text/javascript">
        ...
        function operateFormatter(value, row, index) {//赋予的参数
            return [
                ...
                '<button class="btn btn-default details btn-xs" value="'+row.id+'" onclick="detail(value)">删除</button>&nbsp;',
                '<button class="btn btn-default delete btn-xs" onclick="deleteThis(this)" data-id="'+row.id+'">日志</button>',
            ].join('');
        }
